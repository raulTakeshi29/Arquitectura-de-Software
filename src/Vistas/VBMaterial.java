...
public class VBMaterial extends java.awt.Dialog implements IBMaterial{
     ...
     */
    public VBMaterial(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(material, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 50, 90, 30));
...
@Override
    public void setPresentador(PBMaterial p) {
    ...
    @Override
    public int getItem() {
        if(materiales.getSelectedRow()!=-1){
            return Integer.parseInt(String.valueOf(materiales.getValueAt(materiales.getSelectedRow(), 0)));
        } else{
            return -1;
        }
    }
    ...
    public void setSalida(String[][] lista) {
        materiales.setModel(new javax.swing.table.DefaultTableModel(lista,new String [] {"Id", "Nombre","Unidad","Grupo"}));
    }
